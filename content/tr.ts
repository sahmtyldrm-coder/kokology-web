  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Turşu Suyu", price: 90 as number | null, note: "" },
        { name: "Adanus Şalgam", price: 100 as number | null, note: "", image: "/images/icecek/salgam-suyu-acili-kokology-bursa-nilufer.png", alt: "Acılı şalgam suyu şişesi — Kokology Bursa Nilüfer Ataevler" },
        { name: "Şıra", price: 110 as number | null, note: "", image: "/images/icecek/sira-rifat-minare-kokology-bursa-nilufer.png", alt: "Rifat Minare Şıra şişesi, 250ml — Kokology Bursa Nilüfer Ataevler" },
        { name: "Coca Cola", price: 110 as number | null, note: "", image: "/images/icecek/coca-cola-kutu-kokology-bursa-nilufer.png", alt: "Coca-Cola kutu — Kokology Bursa Nilüfer Ataevler" },
        { name: "Uludağ Portakallı", price: 100 as number | null, note: "", image: "/images/icecek/uludag-portakalli-gazoz-kokology-bursa-nilufer.png", alt: "Uludağ portakallı gazoz şişesi — Kokology Bursa Nilüfer Ataevler" },
        { name: "Uludağ Gazoz", price: 100 as number | null, note: "", image: "/images/icecek/uludag-efsane-gazoz-kokology-bursa-nilufer.png", alt: "Uludağ Efsane Gazoz şişesi — Kokology Bursa Nilüfer Ataevler" },
        { name: "Uludağ Limonata", price: 100 as number | null, note: "", image: "/images/icecek/uludag-limonata-kokology-bursa-nilufer.png", alt: "Uludağ Limonata şişesi, 330ml — Kokology Bursa Nilüfer Ataevler" },
        { name: "Uludağ Maden Suyu", price: 50 as number | null, note: "", image: "/images/icecek/uludag-maden-suyu-kokology-bursa-nilufer.png", alt: "Uludağ maden suyu şişesi — Kokology Bursa Nilüfer Ataevler" },
        { name: "Uludağ Premium Su", price: 40 as number | null, note: "", image: "/images/icecek/uludag-premium-su-kokology-bursa-nilufer.png", alt: "Uludağ Premium Su şişesi — Kokology Bursa Nilüfer Ataevler" },
      ],
    },
  ],
};
...
export const faq = {
  ...
  items: [
    ...
    },
    {
      ...
      a: "Çeyrek kokoreç 230 ₺, yarım 380 ₺, üç çeyrek 580 ₺, tam kokoreç 740 ₺, porsiyon kokoreç 800 ₺. Uykuluklu Yarım Atom 650 ₺, Special Atom 1200 ₺. Güncel liste menü sayfamızda.",
    },
    {
